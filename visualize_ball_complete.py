#!/usr/bin/env python3
"""
Parse and visualize all patches from ball actor mesh
"""
...
def visualize_all_patches(patches, title="All Patches", view_angles=(20, 45)):
    ...
    if all_faces:
        ...
        # Make it look more spherical by equal aspect
...
def main():
    ...
    views = [
        ('ball_12_complete_isometric.png', (20, 45), 'Isometric'),
        ('ball_12_complete_front.png', (0, 0), 'Front'),
        ('ball_12_complete_top.png', (90, 0), 'Top'),
        ('ball_12_complete_side.png', (0, 90), 'Side'),
        ('ball_12_complete_angle1.png', (30, -60), 'Angle 1'),
        ('ball_12_complete_angle2.png', (30, 135), 'Angle 2'),
    ]
    
    for filename, (elev, azim), label in views:
        print(f"Creating {label} view...")
        fig = visualize_all_patches(all_patches, f"Ball Actor 12 - {label} ({len(all_patches)} patches)")
